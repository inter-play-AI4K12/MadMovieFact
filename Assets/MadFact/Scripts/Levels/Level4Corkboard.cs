...
namespace MadFact
{
    ...
    public class Level4Corkboard : MonoBehaviour
    {
        ...
        Image[] _gapBars = new Image[4];
        Image[] _posterBars = new Image[4];
        Text _matchText, _verdict;
        Image _matchFill;
        Button _greenlight;
        bool _won;
        ...
        void Build(Transform canvas)
        {
            ...
            _root = UIFactory.Image(canvas, "Level4Corkboard", new Color(0.30f, 0.20f, 0.10f)).gameObject;
            ...
            UIFactory.Place(UIFactory.RT(posterFrame.gameObject), new Vector2(0.5f, 0.5f), new Vector2(0.5f, 0.5f), new Vector2(420, 380), new Vector2(-120, 0));
        ...
        void AddSticker(int defIndex)
        {
            ...
            var pic = UIFactory.Image(card.transform, "Pic", d.Color);
            UIFactory.Place(UIFactory.RT(pic.gameObject), new Vector2(0.5f, 1), new Vector2(0.5f, 1), new Vector2(74, 56), new Vector2(0, -6));
            var glyph = UIFactory.Text(pic.transform, "G", d.Label, 12, Color.white, Theme.SystemSans, TextAnchor.MiddleCenter, true, FontStyle.Bold);
            UIFactory.Fill(UIFactory.RT(glyph.gameObject), 2, 2, 2, 2);
