...
namespace MadFact
{
    ...
    public class Level2Robot : MonoBehaviour
    {
        ...
        Text _genreSel, _movieSel, _rulesText, _log, _summary;
        Button _runBtn;
        bool _running;
        ...
        {
            _root = UIFactory.Image(canvas, "Level2Robot", new Color(0, 0, 0, 0.4f)).gameObject;
            UIFactory.Fill(UIFactory.RT(_root), 40, 40, 40, 0);

            // beige plastic terminal chassis
            var chassis = UIFactory.Bevel(_root.transform, "Chassis", Theme.Plastic);
