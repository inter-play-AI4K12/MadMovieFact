...
namespace MadFact
{
    ...
    public class MadFactBootstrap : MonoBehaviour
    {
        ...
        void EnsureCamera()
        {
            ...
            if (cam.GetComponent<AudioListener>() == null && Object.FindFirstObjectByType<AudioListener>() == null)
        ...
        void EnsureManagers()
        {
            ...
            if (Object.FindFirstObjectByType<AudioListener>() == null) AudioTension.I.gameObject.AddComponent<AudioListener>();
        }

        void BuildCanvasAndEventSystem()
        {
        ...
        void ShowWin()
        {
            ...
            var card = UIFactory.Bevel(dim.transform, "Card", Theme.Face);
            ...
            UIFactory.Place(UIFactory.RT(UIFactory.Text(card.transform, "t", "★  BLOCKBUSTER GREENLIT  ★", 26, Theme.Ink, Theme.Typewriter, TextAnchor.MiddleCenter, false, FontStyle.Bold).gameObject),
                new Vector2(0.5f, 1), new Vector2(0.5f, 1), new Vector2(520, 60), new Vector2(0, -30));
            UIFactory.Place(UIFactory.RT(UIFactory.Text(card.transform, "b",
                ...
                new Vector2(0.5f, 1), new Vector2(0.5f, 1), new Vector2(500, 180), new Vector2(0, -90));
