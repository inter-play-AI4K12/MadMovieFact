...
namespace MadFact
{
    ...
    public static class Theme
    {
        ...
        public static Font Typewriter =>
            _typewriter != null ? _typewriter : (_typewriter = LoadOS(new[] { "Menlo", "Monaco", "Courier New", "Consolas" }));

        /// <summary>Rigid aliased system font (Robot / OS chrome).</summary>
        public static Font SystemSans =>
            _system != null ? _system : (_system = LoadOS(new[] { "Avenir Next", "Helvetica Neue", "Arial", "Tahoma" }));
        ...
        static Font LoadOS(string[] names)
        {
            ...
            try
            {
                ...
                // crisp downscaling in small Game views.
