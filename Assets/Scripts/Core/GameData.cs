...
namespace MadFact
{
    ...
    public static class GameData
    {
        ...
        // ---- The catalog -------------------------------------------------
        // Famous films students will actually recognize (per Erfan: real movies, none
        // rated R, at most ten per genre) — classics where they're still household names,
        // modern picks where the old ones aged out. The mainframe uses its own fictional
        ...
        public static readonly List<MovieData> Movies = new List<MovieData>
        {
            ...
            new MovieData("THE INCREDIBLES",    Genre.Action,      2004, AgeRating.PG,   new Latent(0.20f,0.10f,0.65f,0.80f), F(Genre.Action,0.80f, Genre.Animation,0.70f, Genre.Comedy,0.50f), Col(140,25,25), Col(250,180,60), "A superhero family, illegally super."),
            ...
            new MovieData("WALL-E",             Genre.SciFi,       2008, AgeRating.G,    new Latent(0.90f,0.02f,0.55f,0.15f), F(Genre.SciFi,0.80f, Genre.Animation,0.80f),                   Col(25,35,45),   Col(230,180,90),  "The last robot on Earth falls in love."),
            ...
            new MovieData("NIGHT AT THE MUSEUM", Genre.Comedy,     2006, AgeRating.PG,   new Latent(0.05f,0.25f,0.80f,0.40f), F(Genre.Comedy,0.85f, Genre.Action,0.40f),                     Col(30,40,80),   Col(240,200,110), "After dark, the exhibits wake up.", "NIGHT@MUSEUM"),
            new MovieData("PADDINGTON",         Genre.Comedy,      2014, AgeRating.PG,   new Latent(0.02f,0.02f,0.90f,0.15f), F(Genre.Comedy,0.90f),                                          Col(60,90,140),  Col(230,90,60),   "A very polite bear. A very chaotic London."),
            ...
            new MovieData("THE PRINCESS DIARIES", Genre.Romance,   2001, AgeRating.G,    new Latent(0.02f,0.02f,0.85f,0.02f), F(Genre.Romance,0.80f, Genre.Comedy,0.60f),                    Col(140,70,90),  Col(245,210,200), "Surprise: you're a princess. Please stop falling over.", "PRINCESS DIARIES"),
            new MovieData("ENCHANTED",          Genre.Romance,     2007, AgeRating.PG,   new Latent(0.05f,0.05f,0.85f,0.10f), F(Genre.Romance,0.90f, Genre.Comedy,0.50f, Genre.Animation,0.30f), Col(70,60,110), Col(240,180,210), "A cartoon princess lands in real New York."),
            ...
            new MovieData("HOLES",              Genre.Drama,       2003, AgeRating.PG,   new Latent(0.05f,0.45f,0.40f,0.15f), F(Genre.Drama,0.80f, Genre.Comedy,0.40f),                      Col(180,140,70), Col(240,220,160), "Dig a hole a day. Ask why later."),
            ...
            new MovieData("WONDER",             Genre.Drama,       2017, AgeRating.PG,   new Latent(0.02f,0.30f,0.40f,0.02f), F(Genre.Drama,0.90f),                                          Col(60,80,150),  Col(240,235,225), "Be kind. It's harder and better than cool."),
            new MovieData("MARCH OF THE PENGUINS", Genre.Documentary, 2005, AgeRating.G, new Latent(0.05f,0.15f,0.30f,0.02f), F(Genre.Documentary,0.95f),                                    Col(30,50,80),   Col(230,240,250), "Antarctica. Eggs. Absolute devotion.", "PENGUINS"),
            new MovieData("FREE SOLO",          Genre.Documentary, 2018, AgeRating.PG13, new Latent(0.10f,0.60f,0.05f,0.50f), F(Genre.Documentary,0.90f),                                    Col(150,90,50),  Col(240,200,140), "3,000 feet. No rope."),
            ...
            new MovieData("FROZEN",             Genre.Animation,   2013, AgeRating.PG,   new Latent(0.05f,0.15f,0.75f,0.20f), F(Genre.Animation,0.95f, Genre.Comedy,0.50f),                  Col(40,70,110),  Col(180,225,245), "Let it go. The cold never bothered her anyway."),
        };
