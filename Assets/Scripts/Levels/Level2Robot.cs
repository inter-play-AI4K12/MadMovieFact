...
namespace MadFact
{
    ...
    public class Level2Robot : MonoBehaviour
    {
        ...
        void Build(Transform parent)
        {
            ...
            UIFactory.Place(UIFactory.RT(UIFactory.Text(builder.transform, "i2", "THEN  RECOMMEND:", 14, Theme.Ink, Theme.SystemSans, TextAnchor.MiddleLeft, false, FontStyle.Bold).gameObject),
